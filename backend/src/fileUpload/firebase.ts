...
export class FirebaseUtils extends Provider {
    ...
    public async uploadImage(filename: string, filePath: string): Promise<string> {
        ...
        try {
            ...
            uploadTasks.push(this.bucket.upload(`${dir}/${filename}.jpeg`, {
                destination: `${filePath}/${filename}/normal.jpeg`,
            }));
            uploadTasks.push(this.bucket.upload(`${dir}/${filename}_md.jpeg`, {
                destination: `${filePath}/${filename}/medium.jpeg`,
            }));
            uploadTasks.push(this.bucket.upload(`${dir}/${filename}_sm.jpeg`, {
        ...
        return `https://firebasestorage.googleapis.com/v0/b/cs-par-le-monde-1.appspot.com/o/${filePath.replace(/\//gmi, '%2F')}%2F${filename}%2Fnormal.jpeg?alt=media`;
    }
